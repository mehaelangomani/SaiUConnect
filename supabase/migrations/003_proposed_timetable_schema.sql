-- =============================================================================
-- SaiUConnect Timetable Schema — PROPOSED MIGRATION
-- =============================================================================
--
-- STATUS: NOT YET EXECUTED — FOR REVIEW ONLY
--
-- Do NOT run this file in Supabase until the schema has been reviewed and
-- approved. This migration does not modify the existing `profiles` table.
--
...
-- CREATE INDEX faculty_members_profile_id_idx ON public.faculty_members (profile_id);
-- CREATE INDEX faculty_members_school_id_idx ON public.faculty_members (school_id);
...
-- CREATE INDEX rooms_availability_status_idx ON public.rooms (availability_status);
...
-- CREATE INDEX time_slots_day_period_idx ON public.time_slots (day_of_week, period_number);
...
-- CREATE UNIQUE INDEX timetable_entries_room_slot_unique
...
-- CREATE INDEX timetable_entry_audiences_entry_idx
--   ON public.timetable_entry_audiences (timetable_entry_id);
-- CREATE INDEX timetable_entry_audiences_lookup_idx
--   ON public.timetable_entry_audiences (audience_type, audience_code);

-- -----------------------------------------------------------------------------
-- ROW LEVEL SECURITY (PLACEHOLDER — enable in a future migration)
-- -----------------------------------------------------------------------------
--
...
-- -----------------------------------------------------------------------------
-- HELPER VIEW (OPTIONAL — for student timetable queries)
-- -----------------------------------------------------------------------------
...
-- =============================================================================
-- END OF PROPOSED MIGRATION — NOT YET EXECUTED
-- =============================================================================
